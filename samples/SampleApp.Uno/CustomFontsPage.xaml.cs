...
/// <summary>
/// Demonstrates custom font support in KumikoUI (← SampleApp.Maui CustomFontsPage):
/// <list type="bullet">
...
/// </list>
/// Both typefaces are registered in <see cref="App.OnLaunched"/> via
/// <c>KumikoFonts.RegisterFromAppPackageAsync</c>.
/// </summary>
public sealed partial class CustomFontsPage : Page
{
    // ── Material Icons Unicode code points ────────────────────────
    // These are the glyph addresses (private-use area) in the MaterialIcons-Regular.ttf font.
    ...
    private static ObservableCollection<InventoryItem> GenerateInventoryData()
    {
        ...
        string[] warehouses = ["東京", "大阪", "京都", "名古屋", "福岡"]; // 東京/大阪/京都/名古屋/福岡
    ...
    {
        // Regular columns use the default font; only the Priority/Done columns use MaterialIcons.
    ...
    private static ObservableCollection<TaskItem> GenerateTaskData()
    {
